export default function esqueceuSenha() {
    return (
      <main className="bg-[url('../../public/imagem_profissional.png')] bg-no-repeat bg-right-bottom min-h-screen flex justify-center items-center">
        <div className="bg-gray-800 p-8 rounded-lg shadow-lg w-full max-w-md">
          ...
          <div className="text-center mt-8">
            <p className="text-gray-200">
              Lembrou a senha?{' '}
              <a href="/login" className="text-yellow-600 text-sm hover:text-yellow-500">
                Voltar ao login
              </a>
            </p>
          </div>
